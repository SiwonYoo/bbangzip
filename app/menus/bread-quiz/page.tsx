  ...
  const quizMenus = [
    {
      ...
      imgPath: "/images/bbangzip-icons/category-quiz-icon.png",
      title: "빵 카테고리 퀴즈",
      description: "🌱 Lv.1 | 빵린이의 첫걸음",
    },
    {
      link: "./bread-quiz/real-quiz",
      imgPath: "/images/bbangzip-icons/real-quiz-icon.png",
      title: "퀴즈 - 실전편",
      description: "🔥 Lv.2 | 이제 진짜 빵이다!",
    },
    {
      link: "./bread-quiz/master-quiz",
      imgPath: "/images/bbangzip-icons/master-quiz-icon.png",
      title: "퀴즈 - 심화편",
